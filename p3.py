...
Gist
 ...
 Unwatch 4
  Star 0
  Fork 0 achiang31/Train_4400
 Code  Issues 0  Pull requests 0  Wiki  Pulse  Graphs
Branch: master Find file Copy pathTrain_4400/Newphase3.py
a6cd4c9  a minute ago
@achiang31 achiang31 resolved new conflicts
3 contributors @achiang31 @anjiagr @arthinithi
RawBlameHistory     1206 lines (1013 sloc)  48.8 KB
...
############train number,table info
    def viewReview(self):
        ...
        e1 = Entry(frame, textvariable = self.trainReviewNum, width = 20)
        e1.grid(row = 0, column = 1)
    ...
    def viewReview2(self):
        ...
        server = self.Connect()
        cursor = server.cursor()
        query = "SELECT Comment, Rating FROM REVIEW WHERE REVIEW.Train_Number = '%d'" % (trainReviewNum)
        cursor.execute(query)
        results = cursor.fetchall()
...
app = Phase_three(mw)
mw.mainloop()
>>>>>>> 767de1bb5cbc35665a55245ee342a2de3cdd6138:p3.py
>>>>>>> 2a4bfd2a620d36e106263e43413f3dda2393eafc
